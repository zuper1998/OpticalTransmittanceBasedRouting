...
def visu(retro,cros):
    ...
    fig.add_trace(go.Scatter(y= x_val, x=retro,name="Retrográd",mode='markers',marker=dict(size=20)))
    fig.add_trace(go.Scatter(y= x_val, x=cros,name="Keresztpálya",mode='markers',marker=dict(size=20)))
